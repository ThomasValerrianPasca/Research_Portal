...
Tested up to: WordPress 3.9.1 with BuddyPress 2.0.1
Stable tag: 1.3.3
License: GPLv2 or later
License URI: http://www.gnu.org/licenses/gpl-2.0.html

This plugin allows you to add fields of type Image to user profile screens without having to write any custom code.
