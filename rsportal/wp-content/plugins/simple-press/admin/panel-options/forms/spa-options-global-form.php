...
$LastChangedDate: 2014-05-30 03:18:14 -0700 (Fri, 30 May 2014) $
$Rev: 11479 $
*/
	...
	spa_paint_open_tab(spa_text('Options').' - '.spa_text('Global Settings'));
		...
		spa_paint_open_panel();
			spa_paint_open_fieldset(spa_text('Flood Control'), true, 'flood-control');
				spa_paint_input(spa_text('Flood control interval required between multiple posts from single user'), 'floodcontrol', $sfoptions['floodcontrol']);
			spa_paint_close_fieldset();
		spa_paint_close_panel();
