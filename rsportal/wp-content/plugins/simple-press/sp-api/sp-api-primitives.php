...
$LastChangedDate: 2014-08-12 17:19:23 -0700 (Tue, 12 Aug 2014) $
$Rev: 11868 $
*/
...
function sp_add_activity($userid, $type, $value, $meta='', $doCheck = true) {
	...
	$sql =  'INSERT INTO '.SFUSERACTIVITY.
			"(user_id, type_id, item_id $mCol)
			VALUES
			($userid, $type, $value $mVal)";
...
function sp_get_activity($userid, $type, $value, $meta='') {
	...
	$sql = 	'SELECT id FROM '.SFUSERACTIVITY.
			" WHERE user_id=$userid AND type_id=$type AND item_id=$value AND meta_id $m";
