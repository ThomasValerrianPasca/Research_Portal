...
<input type="button" class="btn btn-primary" onClick="location.href=''" value='Biotechnology Dept. Homepage'>
<button class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-lg">People</button>
<input type="button" class="btn btn-primary" onClick="location.href='/rsportal/category/biotechnology/'" value='Biotechnology Blog'>
</div>
...
<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
    	<div class="jumbotron">
    		<h3> People at Biotechnology, IIT Hyderabad </h3>
      <?php  $userscse = get_users(array('meta_key' => 'department' , 'meta_value' => 'biotech')); 
...
<div class="jumbotron" id="containercse1" >
 <img src="http://i1166.photobucket.com/albums/q620/rohithreddy95/98-horz_zpsaab1ec70.jpg~original">
</div>
<div class="row">
        <div class="col-md-9" id="containercse2">
	<h2><a href="<?php the_permalink(); ?>"><?php the_title();?> </a> </h2>
	<?php
	$homepage = get_post(154);
