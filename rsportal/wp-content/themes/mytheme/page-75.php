...
<input type="button" class="btn btn-primary" onClick="location.href=''" value='Dept. Homepage'>
<button class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-lg">People</button>
<input type="button" class="btn btn-primary" onClick="location.href='/rsportal/category/mechanical/'" value='Dept. Blog'>
</div>
...
<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
    	<div class="jumbotron">
    		<h3> People at Dept. of Mechanical & Aerospace Engg., IIT Hyderabad </h3>
      <?php  $userscse = get_users(array('meta_key' => 'department' , 'meta_value' => 'mech')); 
...
<div class="jumbotron" id="containercse1" >
 <img src="http://i1166.photobucket.com/albums/q620/rohithreddy95/52-horz_zps20fb7b01.jpg~original">
</div>
