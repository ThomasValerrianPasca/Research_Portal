...
<input type="button" class="btn btn-primary" onClick="location.href=''" value='Chemical Engg. Dept. Homepage'>
<button class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-lg">People</button>
<input type="button" class="btn btn-primary" onClick="location.href='/rsportal/category/chemicalengg/'" value='Chemical Engg. Blog'>
</div>
...
<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
    	<div class="jumbotron">
    		<h3> People at Chemical Engg., IIT Hyderabad </h3>
      <?php  $userscse = get_users(array('meta_key' => 'department' , 'meta_value' => 'chemical')); 
...
<div class="jumbotron" id="containercse1" >
 <img src="http://i1166.photobucket.com/albums/q620/rohithreddy95/chemical2_zps0bfd0343.jpg~original">
</div> -->
