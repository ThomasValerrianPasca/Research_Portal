...
<input type="button" class="btn btn-primary" onClick="location.href=''" value='Chemistry Dept. Homepage'>
<button class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-lg">People</button>
<input type="button" class="btn btn-primary" onClick="location.href='/rsportal/category/chemistry/'" value='Chemistry Blog'>
</div>
...
<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
    	<div class="jumbotron">
    		<h3> People at Dept. Of Chemistry, IIT Hyderabad </h3>
      <?php  $userscse = get_users(array('meta_key' => 'department' , 'meta_value' => 'chemistry')); 
...
<!--<div class="jumbotron" id="containercse1" >
 <img src="http://i1166.photobucket.com/albums/q620/rohithreddy95/4-horz1_zps984987a1.jpg~original">
</div> -->
<div class="jumbotron thumbnail" id="containercse1">
<?php
if( function_exists('FA_display_slider') ){
    FA_display_slider(541);
    }
    ?>
</div>
